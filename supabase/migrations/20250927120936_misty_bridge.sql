...
INSERT INTO permissions (user_id, can_view, can_edit, can_delete) VALUES
  ('770e8400-e29b-41d4-a716-446655440003', '{"attendances": true, "users": "department", "events": true}', '{"attendances": true, "checklists": true}', '{}'),
  ('770e8400-e29b-41d4-a716-446655440004', '{"attendances": true, "users": "department", "events": true}', '{"attendances": true}', '{}'),
  ('770e8400-e29b-41d4-a716-446655440005', '{"attendances": true, "users": "department", "events": true, "checklists": true}', '{"attendances": true, "checklists": true}', '{}'),
  ('770e8400-e29b-41d4-a716-446655440006', '{"attendances": true, "users": "department", "events": true}', '{"attendances": true}', '{}');
